...
document.querySelectorAll('.nav-tab').forEach(tab => {
  tab.addEventListener('click', function(e) {
    // Add animation class to the tabs
    const navTabs = document.getElementById("navTabs");
    navTabs.classList.add("transitioning");

    // Set a small timeout to remove the class after the transition
    setTimeout(() => {
      navTabs.classList.remove("transitioning");
